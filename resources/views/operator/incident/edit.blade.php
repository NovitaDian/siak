    ...
    <div class="container-fluid py-4 px-0">
        <div class="card mx-auto w-100" style="max-width: 150%; ">
            ...
            <div class="card-body pt-2 p-3">
                <form action="{{ route('operator.incident.update', $incidents->id) }}" method="POST" role="form text-left">
                    @csrf
                    @method('PUT')
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="hse_inspector_id" name="hse_inspector_id">
                                    ...
                                    <option value="{{ $officer->id }}" {{ old('hse_inspector_id', $incidents->hse_inspector_id) == $officer->id ? 'selected' : '' }}>
                                        {{ $officer->name }}
                                    </option>
                                    @endforeach
                                </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="perusahaan_id" name="perusahaan_id">
                                            <option value="" disabled {{ old('perusahaan_id', $incidents->perusahaan_id ?? '') ? '' : 'selected' }}>Pilih Perusahaan</option>
                                            @foreach($perusahaans as $perusahaan)
                                            <option value="{{ $perusahaan->id }}"
                                                {{ (string) old('perusahaan_id', $incidents->perusahaan_id ?? '') === (string) $perusahaan->id ? 'selected' : '' }}>
        ...
        <script>
            $(document).ready(function() {
                const oldPerusahaan = "{{ old('perusahaan_id', $incidents->perusahaan_id ?? '') }}";
