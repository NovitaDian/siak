        ...
        <div class="row">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center pb-0">
                    ...
                    <form action="{{ route('operator.non_compliant.create') }}" method="GET" class="mb-0">
                        @csrf
                            ...
                            <tbody id="draftTableBody">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-xs">
                                        ...
                                        <form action="{{ route('operator.non_compliant.destroy', $noncompliant->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
...
<script>
    ...
    function editAction(id) {
        window.location.href = "{{ url('operator/non_compliant/edit') }}/" + id;
    }
</script>
