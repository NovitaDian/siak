    ...
    <div class="col-xl-6 col-sm-12 mb-xl-0 mb-4">
        <div class="card h-100 p-3">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <button class="btn btn-primary btn-sm" onclick="location.href='{{ route('operator.budget.index') }}'">Lihat Rincian</button>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-6 col-sm-12 mb-xl-0 mb-4">
        <div class="card h-100 p-3">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <button class="btn btn-primary btn-sm" onclick="location.href='{{ route('operator.pr.index') }}'">Lihat Rincian</button>
            </div>
        </div>
    </div>
</div>
