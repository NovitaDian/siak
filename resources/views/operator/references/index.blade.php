...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('operator.references.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <table class="table align-items-center mb-0" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('operator.references.destroy', $document->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
