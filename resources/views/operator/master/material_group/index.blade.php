        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <form action="{{ route('operator.material_group.create') }}" method="GET">
                        @csrf
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <!-- Tombol Edit -->
                                        <a href="{{ route('operator.material_group.edit', $material_group->id) }}" class="btn btn-warning btn-xs">
                                            <i class="fas fa-edit me-1"></i> Edit
                                        </a>

                                        <!-- Tombol Hapus -->
                                        <form action="{{ route('operator.material_group.destroy', $material_group->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
