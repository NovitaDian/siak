                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <!-- Tombol Delete (Send Action) -->
                                            <form action="{{ route('adminsystem.ncr.Perusahaandestroy', $bagian->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="btn btn-sm"
                                        ...
                                        <script>
                                            function editAction() {
                                                // Redirect to the edit form for the item
                                                window.location.href = "{{ route('adminsystem.ncr.Perusahaanedit', $bagian->id) }}";
                                            }
                                        </script>
                                        </td>
                                    </tr>
