                                ...
                                <tbody id="notificationTableBody">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('operator.ncr.approve', $request->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                <button type="submit" class="btn btn-primary btn-xs">Approve</button>
                                            </form>

                                            <form action="{{ route('operator.ncr.reject', $request->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                <button type="submit" class="btn btn-danger btn-xs">Reject</button>
                                            </form>
                                            @endif
                                            <form action="{{ route('operator.ncr.show', ['id' => $request->sent_ncr_id]) }}" method="GET" style="display:inline;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <div style="display: flex; justify-content: center; gap: 6px;">
                                                <a href="{{ route('operator.ncr.edit', $ncr->id) }}" class="btn btn-warning">
                                                    <i class="fas fa-edit me-1" style="font-size: 12px;"></i> Edit
                                                </a>

                                                <form action="{{ route('operator.ncr.destroy', $ncr->id) }}" method="POST" style="margin: 0;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{ route('operator.ncr.index') }}" method="GET" class="row g-3 px-4 mb-3">
                        ...
                        <div class="col-12 col-md-3 d-flex justify-content-md-end justify-content-start align-items-end gap-2">
                            <a href="{{ route('operator.ncr.export', request()->all()) }}" class="btn btn-sm btn-success w-100 w-md-auto">
                                <i class="fas fa-file-excel me-1"></i> Excel
                            </a>
                            <a href="{{ route('operator.ncr.exportPdf', request()->all()) }}" class="btn btn-sm btn-danger w-100 w-md-auto">
                                ...
                                <tr class="sent-ncr-row" data-ncr-id="{{ $ncr_fix->id }}">
                                    ...
                                    <td class="align-middle text-center text-xs">
                                        <div class="d-flex flex-wrap gap-1 justify-content-center">
                                            ...
                                            <a href="{{ route('operator.ncr.edit_closed', $ncr_fix->id) }}" class="btn btn-warning btn-xs">
                                                <i class="fas fa-edit me-1" style="font-size: 12px;"></i> Edit
                                            </a>
                                            @elseif ($ncr_fix->status_ncr === 'Open')
                                            <a href="{{ route('operator.ncr.sent_edit', $ncr_fix->id) }}" class="btn btn-warning btn-xs">
                                                <i class="fas fa-edit me-1" style="font-size: 12px;"></i> Edit
                                            </a>
                                            @endif
                                            @endif
                                            ...
                                            <a href="{{ route('operator.ncr.close', $ncr_fix->id) }}" class="btn btn-secondary btn-sm"
