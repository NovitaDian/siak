...
<div class="container-fluid">
    ...
    <div class="card mx-auto w-100" style="max-width: 150%;">
        ...
        <div class="card-body pt-4 p-3">
            <form action="{{ route('operator.ncr.update', $ncr->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" name="tanggal_shift_kerja" value="{{ old('tanggal_shift_kerja', $ncr->tanggal_shift_kerja) }}" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="nama_hs_officer_1" value="{{ old('nama_hs_officer_1', $ncr->nama_hs_officer_1) }}">
                    </div>

                    <div class="col-md-6">
                        <label for="nama_hs_officer_2">Nama H&S Officer 2</label>
                        <input type="text" class="form-control" name="nama_hs_officer_2" value="{{ old('nama_hs_officer_2', $ncr->nama_hs_officer_2) }}">
                    </div>

                    <div class="col-md-6">
                        <label for="tanggal_audit">Tanggal Audit</label>
                        <input type="date" class="form-control" name="tanggal_audit" value="{{ old('tanggal_audit', $ncr->tanggal_audit) }}" required>
                    </div>

                    <div class="col-md-6">
                        <label for="nama_auditee">Nama Auditee</label>
                        <input type="text" class="form-control" name="nama_auditee" value="{{ old('nama_auditee', $ncr->nama_auditee) }}" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="perusahaan_id" id="perusahaan_id" class="form-control" required>
                            ...
                            <option value="{{ $perusahaan->id }}" {{ $ncr->perusahaan_id == $perusahaan->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="element_referensi_ncr" value="{{ old('element_referensi_ncr', $ncr->element_referensi_ncr) }}" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" name="deskripsi_ketidaksesuaian" rows="4">{{ old('deskripsi_ketidaksesuaian', $ncr->deskripsi_ketidaksesuaian) }}</textarea>
                    </div>

                    <div class="col-md-6">
                        <label for="tindak_lanjut">Tindak Lanjut</label>
                        <textarea class="form-control" name="tindak_lanjut" rows="4">{{ old('tindak_lanjut', $ncr->tindak_lanjut) }}</textarea>
                    </div>

                    <div class="col-md-6">
                        <label for="estimasi">Estimasi Penyelesaian</label>
                        <input type="date" class="form-control" name="estimasi" value="{{ old('estimasi', $ncr->estimasi) }}">
                    </div>
...
<script>
    $(document).ready(function() {
        const oldPerusahaan = "{{ old('perusahaan_id', $ncr->perusahaan_id ?? '') }}";
        const oldBagian = "{{ old('nama_bagian', $ncr->nama_bagian ?? '') }}";
