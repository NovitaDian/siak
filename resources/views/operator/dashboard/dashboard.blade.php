      ...
      <div class="card-body p-3">
        <div class="row">
          ...
          <div class="col-4 text-end">
            <a href="{{ route('operator.dashboard-incident') }}" class="btn btn-primary icon icon-shape shadow text-center border-radius-md">
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          ...
          <div class="col-4 text-end">
            <a href="{{ route('operator.dashboard-spi') }}" class="btn btn-primary icon icon-shape shadow text-center border-radius-md">
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          ...
          <div class="col-4 text-end">
            <a href="{{ route('operator.dashboard-ncr') }}" class="btn btn-primary icon icon-shape shadow text-center border-radius-md">
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          ...
          <div class="col-4 text-end">
            <a href="{{ route('operator.dashboard-budget') }}" class="btn btn-primary icon icon-shape shadow text-center border-radius-md">
