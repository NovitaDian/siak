            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <form method="GET" action="{{ route('operator.dashboard-spi') }}" class="mb-4">
                            <div class="row">
                                <div class="col-md-2">
                        ...
                        <div class="table-responsive p-3">
                            <table class="table table-bordered text-center align-middle" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    'permanent_partial_disability' => ['label' => 'No. of Permanent Partial Disability (PPD)', 'class' => 'table-danger'],
                                    'permanent_total_disability' => ['label' => 'No. of Permanent Total Disability (PTD)', 'class' => 'table-danger'],
