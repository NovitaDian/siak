<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('home') ? 'active' : '') }}" href="{{ url('operator/home') }}">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('dashboard') ? 'active' : '') }}" href="{{ url('operator/dashboard') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <!-- Ganti dengan gambar dashboard -->
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('budget_pr') ? 'active' : '') }}" href="{{ url('budget_pr') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <!-- Ganti dengan gambar dashboard -->
            <img src="{{ asset('../assets/img/money.png') }}" alt="dashboard" width="16" height="16">
          </div>
          <span class="nav-link-text ms-1">Budget & PR</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('inventory') ? 'active' : '') }}" href="{{ url('operator/inventory') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <!-- Ganti dengan gambar dashboard -->
            <img src="{{ asset('../assets/img/box.png') }}" alt="dashboard" width="16" height="16">
          </div>
          <span class="nav-link-text ms-1">Inventory</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('report') ? 'active' : '') }}" href="{{ url('operator/report/') }}" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <!-- Ganti dengan gambar dashboard -->
            <img src="{{ asset('../assets/img/newspaper.png') }}" alt="dashboard" width="16" height="16">
          </div>
          <span class="nav-link-text ms-1">Report</span>
        </a>
        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
          <li><a class="dropdown-item" href="{{ url('operator/report/incident') }}">Incident & Accident</a></li>
          <hr class="dropdown-divider">
          <li><a class="dropdown-item" href="{{ url('report/analytics') }}">Safety Behavior & PPE Compliance</a></li>
          <hr class="dropdown-divider">
          <li><a class="dropdown-item" href="{{ url('report/details') }}">NCR</a></li>
          <hr class="dropdown-divider">
          <li><a class="dropdown-item" href="{{ url('report/details') }}">Tool & Equipment</a></li>
          <hr class="dropdown-divider">
          <li><a class="dropdown-item" href="{{ url('report/details') }}">Daily Activities & Equipment</a></li>
        </ul>

      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('references') ? 'active' : '') }}" href="{{ url('operator/references') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <!-- Ganti dengan gambar dashboard -->
            <img src="{{ asset('../assets/img/book.png') }}" alt="dashboard" width="16" height="16">
          </div>
          <span class="nav-link-text ms-1">References</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('database') ? 'active' : '') }}" href="{{ url('operator/database') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <!-- Ganti dengan gambar dashboard -->
            <img src="{{ asset('../assets/img/database.png') }}" alt="dashboard" width="16" height="16">
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }} " href="{{ url('operator/user-profile') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{ url('operator/user-management') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
