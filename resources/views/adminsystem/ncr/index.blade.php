                                ...
                                <tbody id="notificationTableBody">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @endif
                                            <form action="{{ route('adminsystem.ncr.show', ['id' => $request->id]) }}" method="GET" style="display:inline;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <form action="{{ route('adminsystem.ncr.destroy', $ncr->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <form action="{{ route('adminsystem.ncr.show', ['id' => $ncr->id]) }}" method="GET" style="display:inline;">
