                                ...
                                <tbody id="notificationTableBody">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('adminsystem.ncr.approve', $request->id) }}" method="POST" class="d-inline">
                                                @csrf
                                            ...
                                            <form action="{{ route('adminsystem.ncr.reject', $request->id) }}" method="POST" class="d-inline">
                                                @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <div class="d-flex justify-content-center align-items-center gap-1 flex-nowrap" style="flex-wrap: nowrap;">
                                                ...
                                                <form action="{{ route('adminsystem.ncr.destroy', $ncr->id) }}" method="POST" class="m-0">
                                                    @csrf
                                                    @method('DELETE')
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('adminsystem.ncr.edit', $ncr->id) }}">
                                                                <i class="fas fa-edit me-1" style="font-size: 12px;"></i> Edit
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <form action="{{ route('adminsystem.ncr.show', ['id' => $ncr->id]) }}" method="GET" class="m-0">
                                                        ...
                                                        <li>
                                                            <form action="{{ route('adminsystem.ncr.draft_destroy', $ncr->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                                                @csrf
                                                                @method('DELETE')
                    ...
                    <form action="{{ route('adminsystem.ncr.index') }}" method="GET" class="row g-3 px-4 mb-3">
                        ...
                        <div class="col-12 col-md-3 d-flex justify-content-md-end justify-content-start align-items-end">
                            <div class="dropdown w-100 w-md-auto">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('adminsystem.ncr.export', request()->all()) }}">
                                            <i class="fas fa-file-excel text-success me-2"></i> Excel
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('adminsystem.ncr.exportPdf', request()->all()) }}">
