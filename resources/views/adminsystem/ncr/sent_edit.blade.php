    ...
    <div class="container-fluid py-4 px-0">
        <div class="card mx-auto w-100" style="max-width: 150%;">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('adminsystem.ncr.sent_update', $ncr_fixs->id) }}" method="POST" enctype="multipart/form-data" role="form text-left">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" name="tanggal_shift_kerja" id="tanggal_shift_kerja" value="{{ old('tanggal_shift_kerja', $ncr_fixs->tanggal_shift_kerja) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_hs_officer_1" id="nama_hs_officer_1" class="form-control" value="{{ old('nama_hs_officer_1', $ncr_fixs->nama_hs_officer_1) }}">
                        </div>

                        <div class="col-md-6">
                            <label for="nama_hs_officer_2">Nama H&S Officer 2</label>
                            <input type="text" name="nama_hs_officer_2" id="nama_hs_officer_2" class="form-control" value="{{ old('nama_hs_officer_2', $ncr_fixs->nama_hs_officer_2) }}">
                        </div>

                        <div class="col-md-6">
                            <label for="tanggal_audit">Tanggal Audit</label>
                            <input type="date" name="tanggal_audit" id="tanggal_audit" class="form-control" value="{{ old('tanggal_audit', $ncr_fixs->tanggal_audit) }}" required>
                        </div>

                        <div class="col-md-6">
                            <label for="nama_auditee">Nama Auditee</label>
                            <input type="text" name="nama_auditee" id="nama_auditee" class="form-control" value="{{ old('nama_auditee', $ncr_fixs->nama_auditee) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="element_referensi_ncr" id="element_referensi_ncr" class="form-control" value="{{ old('element_referensi_ncr', $ncr_fixs->element_referensi_ncr) }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea name="deskripsi_ketidaksesuaian" id="deskripsi_ketidaksesuaian" class="form-control" rows="4">{{ old('deskripsi_ketidaksesuaian', $ncr_fixs->deskripsi_ketidaksesuaian) }}</textarea>
                        </div>

                        <div class="col-md-6">
                            <label for="tindak_lanjut">Tindak Lanjut</label>
                            <textarea name="tindak_lanjut" id="tindak_lanjut" class="form-control" rows="4">{{ old('tindak_lanjut', $ncr_fixs->tindak_lanjut) }}</textarea>
                        </div>

                        <div class="col-md-6">
                            <label for="estimasi">Estimasi Penyelesaian</label>
                            <input type="date" name="estimasi" id="estimasi" class="form-control" value="{{ old('estimasi', $ncr_fixs->estimasi) }}">
                        </div>
...
<script>
    $(document).ready(function() {
        $('#perusahaan').on('change', function() {
            ...
            if (perusahaan) {
                $.ajax({
                    url: '/adminsystem/ncr/get-bagian/' + perusahaan,
                    type: 'GET',
