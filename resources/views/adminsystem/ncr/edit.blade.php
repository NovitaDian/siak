...
<div class="container-fluid">
    ...
    <div class="card mx-auto w-100" style="max-width: 150%;">
        ...
        <div class="card-body pt-4 p-3">
            <form action="{{ route('adminsystem.ncr.update', $ncr->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="perusahaan_id" id="perusahaan_id" value="{{ $ncr->perusahaan_id }}">
