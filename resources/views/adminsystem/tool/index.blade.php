                                ...
                                <tbody id="notificationTableBody">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('adminsystem.tool.approve', $request->id) }}" method="POST" class="d-inline">
                                                @csrf
                                            ...
                                            <form action="{{ route('adminsystem.tool.reject', $request->id) }}" method="POST" class="d-inline">
                                                @csrf
