            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('adminsystem.tool.update', $toolReport->id) }}" method="POST" role="form text-left">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="alat_terpakai" name="alat_terpakai" value="{{ old('alat_terpakai', $toolReport->alat_terpakai) }}" required>
                                @error('alat_terpakai')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="kondisi_fisik" name="kondisi_fisik" value="{{ old('kondisi_fisik', $toolReport->kondisi_fisik) }}" required>
                                @error('kondisi_fisik')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="fungsi_kerja" name="fungsi_kerja" value="{{ old('fungsi_kerja', $toolReport->fungsi_kerja) }}" required>
                                @error('fungsi_kerja')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="sertifikasi" name="sertifikasi" required>
                                    <option value="Ada" {{ old('sertifikasi', $toolReport->sertifikasi) == 'Ada' ? 'selected' : '' }}>Ada</option>
                                    <option value="Tidak Ada" {{ old('sertifikasi', $toolReport->sertifikasi) == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                                </select>
                                @error('sertifikasi')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="kebersihan" name="kebersihan" required>
                                    <option value="Bersih" {{ old('kebersihan', $toolReport->kebersihan) == 'Bersih' ? 'selected' : '' }}>Bersih</option>
                                    <option value="Kotor" {{ old('kebersihan', $toolReport->kebersihan) == 'Kotor' ? 'selected' : '' }}>Kotor</option>
                                </select>
                                @error('kebersihan')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="catatan" name="catatan" rows="4">{{ old('catatan', $toolReport->catatan) }}</textarea>
                        @error('catatan')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                        @enderror
                    </div>
