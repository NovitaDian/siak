                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('adminsystem.references.store') }}" method="POST" enctype="multipart/form-data" class="mb-4">
                        ...
                        <div class="form-group">
                            <label for="file">Pilih File:          (Max: 20 Mb)</label>
                        ...
                        <table class="table align-items-center mb-0" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('adminsystem.references.destroy', $document->id) }}" method="POST" onsubmit="return confirm('Anda yakin akan menghapus data ini?')">
                                            @csrf
                                            @method('DELETE')
