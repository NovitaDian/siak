                                ...
                                <tbody id="notificationTableBody">
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('adminsystem.ppe.approve', $request->id) }}" method="POST" class="d-inline">
                                                @csrf
                                            ...
                                            <form action="{{ route('adminsystem.ppe.reject', $request->id) }}" method="POST" class="d-inline">
                                                @csrf
