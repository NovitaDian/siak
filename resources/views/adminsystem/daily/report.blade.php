    ...
    <div class="container-fluid py-4 px-0">
        <div class="card mx-auto w-100" style="max-width: 150%; ">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('adminsystem.daily.store') }}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="shift_kerja" name="shift_kerja" required>
                                    <option value="" {{ old('shift_kerja') == '' ? 'selected' : '' }}>Pilih Shift</option>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="rincian_laporan" name="rincian_laporan" rows="4">{{ old('rincian_laporan') }}</textarea>
