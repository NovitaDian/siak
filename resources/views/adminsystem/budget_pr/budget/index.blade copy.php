                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Price per Unit</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">{{ $glAccount->price_per_unit }}</p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">{{ $glAccount->setahun_qty }}</p>
                                </td>
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">{{ $glAccount->setahun_total}}</p>
                                </td>
