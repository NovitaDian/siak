...
<div>
    <div class="container-fluid ">
        <h2 class="text-black font-weight-bolder text-center">TAMBAH MATERIAL GROUP</h2>
    </div>
    <div class="container-fluid py-4 px-0">
        <div class="card mx-auto w-100" style="max-width: 150%; ">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('adminsystem.material_group.store') }}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                    <div class="mt-3 alert alert-primary alert-dismissible fade show" role="alert">
                        <span class="alert-text text-white">{{ $errors->first() }}</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="material_group">{{ __('Material Group') }}</label>
