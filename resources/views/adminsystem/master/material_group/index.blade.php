...
<div class="nav-item d-flex align-self-end">
    <form action="{{ route('adminsystem.material_group.create') }}" method="GET" style="display:inline;">
        @csrf
        ...
        <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <p class="text-xs font-weight-bold mb-0">{{ $material_group->description }}</p>
                                </td>
                                
                                <td class="align-middle text-center">
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('adminsystem.material_group.edit', $material_group->id) }}"
                                    ...
                                    <form action="{{ route('adminsystem.material_group.destroy', $material_group->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                            class="btn btn-sm"
                    ...
                    @if($material_groups->isEmpty())
                    <div class="text-center p-4">
                        <p class="text-secondary">Tidak ada data Material Group.</p>
                    </div>
                    @endif
