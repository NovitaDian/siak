            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        ...
                        <form action="{{ route('adminsystem.material_group.create') }}" method="GET" class="d-inline">
                            @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <!-- Tombol Edit -->
                                            <a href="{{ route('adminsystem.material_group.edit', $material_group->id) }}" class="btn btn-warning btn-sm">
