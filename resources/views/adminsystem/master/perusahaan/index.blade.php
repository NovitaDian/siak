            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h6>PERUSAHAAN</h6>
                        <form action="{{ route('adminsystem.perusahaan.create') }}" method="GET" class="d-inline">
                            @csrf
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table id="perusahaanTable" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <!-- Tombol Edit -->
                                            <a href="{{ route('adminsystem.perusahaan.edit', $per->perusahaan_code) }}" class="btn btn-warning btn-sm">
                                                <i class="fas fa-edit me-1"></i> Edit
                                            </a>

                                            <!-- Tombol Hapus -->
                                            <form action="{{ route('adminsystem.perusahaan.destroy', $per->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
