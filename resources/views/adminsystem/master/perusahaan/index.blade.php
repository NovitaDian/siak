            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h6>PERUSAHAAN</h6>
                        <div class="nav-item">
                            <form action="{{ route('adminsystem.perusahaan.create') }}" method="GET" style="display:inline;">
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            <form action="{{ route('adminsystem.perusahaan.destroy', $per->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="btn btn-sm"
                                        ...
                                        <script>
                                            function editAction() {
                                                ...
                                                window.location.href = "{{ route('adminsystem.perusahaan.edit', $per->perusahaan_code) }}";
                                            }
                                        </script>
                                        </td>
                                    </tr>
