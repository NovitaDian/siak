    ...
    <div class="container-fluid py-4 px-0">
        <div class="card mx-auto w-100" style="max-width: 150%; ">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('adminsystem.detail_alat.update', $alat->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="nomor" name="nomor" value="{{ old('nomor', $alat->nomor) }}" required>
                                    @error('nomor')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" id="durasi_inspeksi" name="durasi_inspeksi" value="{{ old('durasi_inspeksi', $alat->durasi_inspeksi) }}" min="0" required>
