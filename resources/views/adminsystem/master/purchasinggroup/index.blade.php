...
<div class="nav-item d-flex align-self-end">
    <form action="{{ route('adminsystem.purchasinggroup.create') }}" method="GET" style="display:inline;">
        @csrf
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <!-- Tombol Edit -->
                                    <a href="{{ route('adminsystem.purchasinggroup.edit', $pur->id) }}"
                                    ...
                                    <form action="{{ route('adminsystem.purchasinggroup.destroy', $pur->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                            class="btn btn-sm"
