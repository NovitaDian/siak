    ...
    <div class="container-fluid py-4 px-0">
        <div class="card mx-auto w-100" style="max-width: 150%; ">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('adminsystem.purchasinggroup.store') }}" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="pur_grp" name="pur_grp" value="{{ old('pur_grp') }}" required>
                                @error('pur_grp')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="department" name="department" value="{{ old('department') }}" required>
                                @error('department')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
