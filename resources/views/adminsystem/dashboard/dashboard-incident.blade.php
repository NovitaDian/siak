        ...
        <div class="col-md-3">
            <form action="{{ route('adminsystem.dashboard-incident') }}" method="GET" class="mb-3">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('adminsystem.dashboard-incident') }}" class="btn btn-secondary btn-sm w-50">Reset</a>
                </div>
            </form>

            <form action="{{ route('adminsystem.update-target-manhours') }}" method="POST">
                @csrf
