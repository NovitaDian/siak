    ...
    <div class="container-fluid py-4 px-0">
        <div class="card mx-auto w-100" style="max-width: 150%; ">
            ...
            <div class="card-body pt-2 p-3">
                <form action="{{ route('adminsystem.incident.sent_update', $incident_fix->id) }}" method="POST" role="form text-left">
                    @csrf
                    @method('PUT')
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="shift" name="shift" required>
                                    <option value="Shift 1" {{ old('shift', $incident_fix->shift) == 'Shift1' ? 'selected' : '' }}>SHIFT I</option>
                                    <option value="Shift 2" {{ old('shift', $incident_fix->shift) == 'Shift2' ? 'selected' : '' }}>SHIFT II</option>
                                    <option value="Shift 3" {{ old('shift', $incident_fix->shift) == 'Shift3' ? 'selected' : '' }}>SHIFT III</option>
