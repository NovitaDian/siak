                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" id="shift_date" name="shift_date" value="{{ old('shift_date', $incidents->shift_date) }}" required>
                                @error('shift_date')
                        ...
                        <div id="additional-forms" style="display: {{ old('status_kejadian', $incidents->status_kejadian) == 'Ada' ? 'block' : 'none' }};">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" id="tgl_kejadiannya" name="tgl_kejadiannya" value="{{ old('tgl_kejadiannya', $incidents->tgl_kejadiannya) }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="perusahaan" name="perusahaan">
                                            <option value="" disabled {{ old('perusahaan') ? '' : 'selected' }}>Pilih Perusahaan</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="jenis_kejadiannya" name="jenis_kejadiannya">
                                    ...
                                    <option value="{{ $jenis }}" {{ old('jenis_kejadiannya') == $jenis ? 'selected' : '' }}>{{ $jenis }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="penjelasan_kejadiannya" rows="3" name="penjelasan_kejadiannya">{{ old('penjelasan_kejadiannya') }}</textarea>
                                @error('penjelasan_kejadiannya') <p class="text-danger text-xs mt-2">{{ $message }}</p> @enderror
                            </div>

                            <div class="form-group">
                                <label for="tindakan_pengobatan">{{ __('Pengobatan yang Diterapkan') }}</label>
                                <textarea class="form-control" id="tindakan_pengobatan" rows="3" name="tindakan_pengobatan">{{ old('tindakan_pengobatan') }}</textarea>
                                @error('tindakan_pengobatan') <p class="text-danger text-xs mt-2">{{ $message }}</p> @enderror
                            </div>

                            <div class="form-group">
                                <label for="tindakan_segera_yang_dilakukan">{{ __('Tindakan Segera yang Dilakukan') }}</label>
                                <textarea class="form-control" id="tindakan_segera_yang_dilakukan" rows="3" name="tindakan_segera_yang_dilakukan">{{ old('tindakan_segera_yang_dilakukan') }}</textarea>
                                @error('tindakan_segera_yang_dilakukan') <p class="text-danger text-xs mt-2">{{ $message }}</p> @enderror
                            </div>
