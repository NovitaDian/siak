    ...
    <div class="container-fluid py-4 px-0">
        <div class="card mx-auto w-100" style="max-width: 150%; ">
            ...
            <div class="card-body pt-2 p-3">
                <form action="{{ route('adminsystem.incident.update', $incidents->id) }}" method="POST" role="form text-left">
                    @csrf
                    @method('PUT')
                    @if($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" id="shift_date" name="shift_date" value="{{ old('shift_date', \Carbon\Carbon::parse($incidents->shift_date)->format('Y-m-d')) }}"
                                    required>
                                @error('shift_date')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="shift" name="shift" required>
                                    <option value="Shift 1" {{ old('shift', $incidents->shift) == 'Shift 1' ? 'selected' : '' }}>SHIFT I</option>
                                    <option value="Shift 2" {{ old('shift', $incidents->shift) == 'Shift 2' ? 'selected' : '' }}>SHIFT II</option>
                                    <option value="Shift 3" {{ old('shift', $incidents->shift) == 'Shift 3' ? 'selected' : '' }}>SHIFT III</option>
                                    <option value="Nonshift" {{ old('shift', $incidents->shift) == 'Nonshift' ? 'selected' : '' }}>NONSHIFT</option>
                                </select>
                                @error('shift')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="safety_officer_1" name="safety_officer_1">
                                    ...
                                    <option value="{{ $officer->name }}" {{ old('safety_officer_1', $incidents->safety_officer_1) == $officer->name ? 'selected' : '' }}>
                                        {{ $officer->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" id="jml_employee" name="jml_employee" min="0" value="{{ old('jml_employee', $incidents->jml_employee) }}" required>
                                @error('jml_employee')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" id="jml_outsources" name="jml_outsources" min="0" value="{{ old('jml_outsources', $incidents->jml_outsources) }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" id="jml_security" name="jml_security" min="0" value="{{ old('jml_security', $incidents->jml_security) }}" required>
                                @error('jml_security')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" id="jml_loading_stacking" name="jml_loading_stacking" min="0" value="{{ old('jml_loading_stacking', $incidents->jml_loading_stacking) }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" id="jml_contractor" name="jml_contractor" min="0" value="{{ old('jml_contractor', $incidents->jml_contractor) }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="status_kejadian" name="status_kejadian" onchange="toggleForms()" required>
                                    <option value="Ada" {{ old('status_kejadian', $incidents->status_kejadian) == 'Ada' ? 'selected' : '' }}>Ada</option>
                                    <option value="Tidak" {{ old('status_kejadian', $incidents->status_kejadian) == 'Tidak' ? 'selected' : '' }}>Tidak</option>
                                </select>
                        ...
                        <div id="additional-forms" style="display: {{ old('status_kejadian', $incidents->status_kejadian) == 'Ada' ? 'block' : 'none' }};">
                            ...
                            <div class="card-body pt-4 p-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" id="tgl_kejadiannya" name="tgl_kejadiannya" value="{{ old('tgl_kejadiannya', \Carbon\Carbon::parse($incidents->tgl_kejadiannya)->format('Y-m-d')) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="time" id="jam_kejadiannya" name="jam_kejadiannya" value="{{ old('jam_kejadiannya', $incidents->jam_kejadiannya) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="lokasi_kejadiannya" name="lokasi_kejadiannya" value="{{ old('lokasi_kejadiannya', $incidents->lokasi_kejadiannya) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="ada_korban" name="ada_korban">
                                                <option value="" {{ old('ada_korban', $incidents->ada_korban) == '' ? 'selected' : '' }}>Pilih Opsi</option>
                                                <option value="Ada" {{ old('ada_korban', $incidents->ada_korban) == 'ada' ? 'selected' : '' }}>Ada</option>
                                                <option value="Tidak" {{ old('ada_korban', $incidents->ada_korban) == 'tidak' ? 'selected' : '' }}>Tidak</option>
                                            </select>
                                            @error('ada_korban')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="klasifikasi_kejadiannya" name="klasifikasi_kejadiannya">
                                            ...
                                            <option value="Near Miss" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Near Miss' ? 'selected' : '' }}>Near Miss</option>
                                            <option value="First Aid" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'First Aid' ? 'selected' : '' }}>First Aid</option>
                                            <option value="Illness/Sick" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Illness/Sick' ? 'selected' : '' }}>Illness/Sick</option>
                                            <option value="Medical Treatment Case (MTC)" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Medical Treatment Case (MTC)' ? 'selected' : '' }}>Medical Treatment Case (MTC)</option>
                                            <option value="Restricted Work Case (RWC)" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Restricted Work Case (RWC)' ? 'selected' : '' }}>Restricted Work Case (RWC)</option>
                                            <option value="Lost Workdays Case (LWC)" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Lost Workdays Case (LWC)' ? 'selected' : '' }}>Lost Workdays Case (LWC)</option>
                                            <option value="Permanent Partial Disability (PPD)" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Permanent Partial Disability (PPD)' ? 'selected' : '' }}>Permanent Partial Disability (PPD)</option>
                                            <option value="Permanent Total Disability (PTD)" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Permanent Total Disability (PTD)' ? 'selected' : '' }}>Permanent Total Disability (PTD)</option>
                                            <option value="Fatality" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Fatality' ? 'selected' : '' }}>Fatality</option>
                                            <option value="Fire Incident" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Fire Incident' ? 'selected' : '' }}>Fire Incident</option>
                                            <option value="Road Incident" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Road Incident' ? 'selected' : '' }}>Road Incident</option>
                                            <option value="Property Loss/Damage" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Property Loss/Damage' ? 'selected' : '' }}>Property Loss/Damage</option>
                                            <option value="Environmental Incident" {{ old('klasifikasi_kejadiannya', $incidents->klasifikasi_kejadiannya) == 'Environmental Incident' ? 'selected' : '' }}>Environmental Incident</option>
                                        </select>
                                        @error('incident')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="form-group d-flex justify-content-between">
                                    <div class="me-2" style="flex: 1;">
                                        ...
                                        <select class="form-control" id="jenis_luka_sakit" name="jenis_luka_sakit">
                                            ...
                                            <option value="{{ $luka->jenis_luka }}" {{ old('jenis_luka_sakit', $incidents->jenis_luka_sakit) == $luka->jenis_luka ? 'selected' : '' }}>
                                                {{ $luka->jenis_luka }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="ms-2" style="flex: 1;">
                                        ...
                                        <select class="form-control" id="jenis_luka_sakit2" name="jenis_luka_sakit2">
                                            <option value="">Pilih Jenis Luka</option>
                                            @foreach($hilangs as $luka)
                                            <option value="{{ $luka->jenis_luka }}" {{ old('jenis_luka_sakit2', $incidents->jenis_luka_sakit2) == $luka->jenis_luka ? 'selected' : '' }}>
                                                {{ $luka->jenis_luka }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="ms-2" style="flex: 1;">
                                        ...
                                        <select class="form-control" id="jenis_luka_sakit3" name="jenis_luka_sakit3">
                                            <option value="">Pilih Jenis Luka</option>
                                            @foreach($hilangs as $luka)
                                            <option value="{{ $luka->jenis_luka }}" {{ old('jenis_luka_sakit3', $incidents->jenis_luka_sakit3) == $luka->jenis_luka ? 'selected' : '' }}>
                                                {{ $luka->jenis_luka }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group d-flex justify-content-between">
                                    <div class="me-2" style="flex: 1;">
                                        ...
                                        <input class="form-control" id="bagian_tubuh_luka" rows="3" name="bagian_tubuh_luka" value="{{ old('bagian_tubuh_luka', $incidents->bagian_tubuh_luka) }}"></input>
                                    ...
                                    <div class="ms-2" style="flex: 1;">
                                        ...
                                        <input class="form-control" id="bagian_tubuh_luka2" rows="3" name="bagian_tubuh_luka2" value="{{ old('bagian_tubuh_luka2', $incidents->bagian_tubuh_luka2) }}"></input>
                                    ...
                                    <div class="ms-2" style="flex: 1;">
                                        ...
                                        <input class="form-control" id="bagian_tubuh_luka3" rows="3" name="bagian_tubuh_luka3" value="{{ old('bagian_tubuh_luka3', $incidents->bagian_tubuh_luka3) }}"></input>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="nama_korban" name="nama_korban" value="{{ old('nama_korban', $incidents->nama_korban) }}">
                                        @error('nama_korban')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option value="Karyawan" {{ old('status', $incidents->status) == 'Karyawan' ? 'selected' : '' }}>{{ __('Karyawan') }}</option>
                                            <option value="Outsourcing/Borongan" {{ old('status', $incidents->status) == 'Outsourcing/Borongan' ? 'selected' : '' }}>{{ __('Outsourcing/Borongan') }}</option>
                                            <option value="Pekerja Borongan" {{ old('status', $incidents->status) == 'Pekerja Borongan' ? 'selected' : '' }}>{{ __('Pekerja Borongan') }}</option>
                                            <option value="Sub Kontraktor" {{ old('status', $incidents->status) == 'Sub Kontraktor' ? 'selected' : '' }}>{{ __('Sub Kontraktor') }}</option>
                                            <option value="Kontraktor" {{ old('status', $incidents->status) == 'Kontraktor' ? 'selected' : '' }}>{{ __('Kontraktor') }}</option>
                                            <option value="Magang" {{ old('status', $incidents->status) == 'Magang' ? 'selected' : '' }}>{{ __('Magang') }}</option>
                                            <option value="Tamu" {{ old('status', $incidents->status) == 'Tamu' ? 'selected' : '' }}>{{ __('Tamu') }}</option>
                                            <option value="Masyarakat Umum" {{ old('status', $incidents->status) == 'Masyarakat Umum' ? 'selected' : '' }}>{{ __('Masyarakat Umum') }}</option>
                                        </select> @error('status')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="jenis_kelamin" name="jenis_kelamin">
                                            ...
                                            <option value="Perempuan" {{ old('jenis_kelamin', $incidents->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>{{ __('Perempuan') }}</option>
                                            <option value="Laki-Laki" {{ old('jenis_kelamin', $incidents->jenis_kelamin) == 'Laki-Laki' ? 'selected' : '' }}>{{ __('Laki-Laki') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- Dropdown Perusahaan -->
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="perusahaan" name="perusahaan">
                                            <option value="" disabled {{ old('perusahaan', $incidents->perusahaan ?? '') ? '' : 'selected' }}>Pilih Perusahaan</option>
                                            @foreach($perusahaans as $perusahaan)
                                            <option value="{{ $perusahaan->perusahaan_name }}"
                                                {{ old('perusahaan', $incidents->perusahaan ?? '') == $perusahaan->perusahaan_name ? 'selected' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="jabatan" name="jabatan"
                                            value="{{ old('jabatan', $incidents->jabatan ?? '') }}">
                                        @error('jabatan')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" id="masa_kerja" name="masa_kerja"
                                            value="{{ old('masa_kerja', $incidents->masa_kerja ?? '') }}">
                                        @error('masa_kerja')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" id="tgl_lahir" name="tgl_lahir" value="{{ old('tgl_lahir', \Carbon\Carbon::parse($incidents->tgl_lahir)->format('Y-m-d')) }}">
                                        @error('tgl_lahir')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="jenis_kejadiannya" name="jenis_kejadiannya">
                                    ...
                                    <option value="{{ $jenis }}"
                                        {{ old('jenis_kejadiannya', $incidents->jenis_kejadiannya ?? '') == $jenis ? 'selected' : '' }}>
                                        {{ $jenis }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="penjelasan_kejadiannya" rows="3" name="penjelasan_kejadiannya">{{ old('penjelasan_kejadiannya', $incidents->penjelasan_kejadiannya ?? '') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="tindakan_pengobatan" rows="3" name="tindakan_pengobatan">{{ old('tindakan_pengobatan', $incidents->tindakan_pengobatan ?? '') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="tindakan_segera_yang_dilakukan" rows="3" name="tindakan_segera_yang_dilakukan">{{ old('tindakan_segera_yang_dilakukan', $incidents->tindakan_segera_yang_dilakukan ?? '') }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="rincian_dari_pemeriksaan" rows="3" name="rincian_dari_pemeriksaan">{{ old('rincian_dari_pemeriksaan', $incidents->rincian_dari_pemeriksaan ?? '') }}</textarea>
                                ...
                                @php
                                $oldA = old('penyebab_langsung_1_a', $incidents->penyebab_langsung_1_a ?? '');
                                $oldB = old('penyebab_langsung_1_b', $incidents->penyebab_langsung_1_b ?? '');
                                $oldA2 = old('penyebab_langsung_2_a', $incidents->penyebab_langsung_2_a ?? '');
                                $oldB2 = old('penyebab_langsung_2_b', $incidents->penyebab_langsung_2_b ?? '');
                                $oldA3 = old('penyebab_langsung_3_a', $incidents->penyebab_langsung_3_a ?? '');
                                $oldB3 = old('penyebab_langsung_3_b', $incidents->penyebab_langsung_3_b ?? '');
                                @endphp
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            @php
                            $oldPDA1 = old('penyebab_dasar_1_a', $incidents->penyebab_dasar_1_a ?? '');
                            $oldPDB1 = old('penyebab_dasar_1_b', $incidents->penyebab_dasar_1_b ?? '');
                            $oldPDC1 = old('penyebab_dasar_1_c', $incidents->penyebab_dasar_1_c ?? '');

                            $oldPDA2 = old('penyebab_dasar_2_a', $incidents->penyebab_dasar_2_a ?? '');
                            $oldPDB2 = old('penyebab_dasar_2_b', $incidents->penyebab_dasar_2_b ?? '');
                            $oldPDC2 = old('penyebab_dasar_2_c', $incidents->penyebab_dasar_2_c ?? '');

                            $oldPDA3 = old('penyebab_dasar_3_a', $incidents->penyebab_dasar_3_a ?? '');
                            $oldPDB3 = old('penyebab_dasar_3_b', $incidents->penyebab_dasar_3_b ?? '');
                            $oldPDC3 = old('penyebab_dasar_3_c', $incidents->penyebab_dasar_3_c ?? '');
                            @endphp
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="me-2" style="flex: 1;">
                                    ...
                                    @php
                                    $value1a = old('tindakan_kendali_untuk_peningkatan_1_a', $incidents->tindakan_kendali_untuk_peningkatan_1_a ?? '');
                                    @endphp
                                ...
                                @php
                                $value1b = old('tindakan_kendali_untuk_peningkatan_1_b', $incidents->tindakan_kendali_untuk_peningkatan_1_b ?? '');
                                $value2b = old('tindakan_kendali_untuk_peningkatan_2_b', $incidents->tindakan_kendali_untuk_peningkatan_2_b ?? '');
                                $value3b = old('tindakan_kendali_untuk_peningkatan_3_b', $incidents->tindakan_kendali_untuk_peningkatan_3_b ?? '');
                                $optionsB = [
                                "Kepemimpinan",
                                ...
                                <div class="ms-2" style="flex: 1;">
                                    ...
                                    <select class="form-control" id="tindakan_kendali_untuk_peningkatan_1_c" name="tindakan_kendali_untuk_peningkatan_1_c">
                                        ...
                                        @elseif(!empty($incidents->tindakan_kendali_untuk_peningkatan_1_c))
                                        <option value="{{ $incidents->tindakan_kendali_untuk_peningkatan_1_c }}" selected>{{ $incidents->tindakan_kendali_untuk_peningkatan_1_c }}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group d-flex mt-3">
                                <div class="me-2" style="flex: 1;">
                                    ...
                                    @php
                                    $value2a = old('tindakan_kendali_untuk_peningkatan_2_a', $incidents->tindakan_kendali_untuk_peningkatan_2_a ?? '');
                                    @endphp
                                ...
                                <div class="ms-2" style="flex: 1;">
                                    ...
                                    <select class="form-control" id="tindakan_kendali_untuk_peningkatan_2_c" name="tindakan_kendali_untuk_peningkatan_2_c">
                                        ...
                                        @elseif(!empty($incidents->tindakan_kendali_untuk_peningkatan_2_c))
                                        <option value="{{ $incidents->tindakan_kendali_untuk_peningkatan_2_c }}" selected>{{ $incidents->tindakan_kendali_untuk_peningkatan_2_c }}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group d-flex mt-3">
                                <div class="me-2" style="flex: 1;">
                                    ...
                                    @php
                                    $value3a = old('tindakan_kendali_untuk_peningkatan_3_a', $incidents->tindakan_kendali_untuk_peningkatan_3_a ?? '');
                                    @endphp
                                ...
                                <div class="ms-2" style="flex: 1;">
                                    ...
                                    <select class="form-control" id="tindakan_kendali_untuk_peningkatan_1_c" name="tindakan_kendali_untuk_peningkatan_1_c">
                                        ...
                                        @elseif(!empty($incidents->tindakan_kendali_untuk_peningkatan_3_c))
                                        <option value="{{ $incidents->tindakan_kendali_untuk_peningkatan_3_c }}" selected>{{ $incidents->tindakan_kendali_untuk_peningkatan_3_c }}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-between">
                                <div class="me-2" style="flex: 1;">
                                    ...
                                    <textarea class="form-control" id="deskripsi_tindakan_pencegahan_1" rows="3" name="deskripsi_tindakan_pencegahan_1">{{ old('deskripsi_tindakan_pencegahan_1', $incidents->deskripsi_tindakan_pencegahan_1 ?? '') }}</textarea>
                                ...
                                <div class="ms-2" style="flex: 1;">
                                    ...
                                    <textarea class="form-control" id="deskripsi_tindakan_pencegahan_2" rows="3" name="deskripsi_tindakan_pencegahan_2">{{ old('deskripsi_tindakan_pencegahan_2', $incidents->deskripsi_tindakan_pencegahan_2 ?? '') }}</textarea>
                                ...
                                <div class="ms-2" style="flex: 1;">
                                    ...
                                    <textarea class="form-control" id="deskripsi_tindakan_pencegahan_3" rows="3" name="deskripsi_tindakan_pencegahan_3">{{ old('deskripsi_tindakan_pencegahan_3', $incidents->deskripsi_tindakan_pencegahan_3 ?? '') }}</textarea>
                            ...
                            <div class="form-group d-flex justify-content-between">
                                <div class="me-2" style="flex: 1;">
                                    ...
                                    <input type="text" class="form-control" id="pic_1" name="pic_1" value="{{ old('pic_1', $incidents->pic_1 ?? '') }}">
                                    @error('pic_1')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="ms-2" style="flex: 1;">
                                    ...
                                    <input type="text" class="form-control" id="pic_2" name="pic_2" value="{{ old('pic_2', $incidents->pic_2 ?? '') }}">
                                    @error('pic_2')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="ms-2" style="flex: 1;">
                                    ...
                                    <input type="text" class="form-control" id="pic_3" name="pic_3" value="{{ old('pic_3', $incidents->pic_3 ?? '') }}">
                                    @error('pic_3')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="timing_1" name="timing_1" value="{{ old('timing_1', $incidents->timing_1 ?? '') }}">
                                    @error('timing_1')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="timing_2" name="timing_2" value="{{ old('timing_2', $incidents->timing_2 ?? '') }}">
                                    @error('timing_2')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-4 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="timing_3" name="timing_3" value="{{ old('timing_3', $incidents->timing_3 ?? '') }}">
                                    @error('timing_3')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="ms-2 mt-3" style="flex: 1;">
                                ...
                                <input class="form-control" id="jml_hari_hilang" type="text" name="jml_hari_hilang" readonly value="{{ old('jml_hari_hilang', $incidents->jml_hari_hilang ?? '') }}">
        ...
        <script>
            $(document).ready(function() {
                const oldPerusahaan = "{{ old('perusahaan', $incidents->perusahaan ?? '') }}";
                const oldBagian = "{{ old('bagian', $incidents->bagian ?? '') }}";

                // Fungsi load Bagian berdasarkan perusahaan
                function loadBagian(perusahaanName, selectedBagian = '') {
                    if (perusahaanName) {
                        $.ajax({
                            url: '/adminsystem/incident/get-bagian/' + encodeURIComponent(perusahaanName),
                            type: 'GET',
