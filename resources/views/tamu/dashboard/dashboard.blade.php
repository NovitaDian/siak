      ...
      <div class="card-body p-3">
        <div class="row">
          ...
          <div class="col-4 text-end">
            <a href="{{ route('tamu.dashboard-incident') }}" class="btn btn-primary icon icon-shape shadow text-center border-radius-md d-flex align-items-center justify-content-center"
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          ...
          <div class="col-4 text-end">
            <a href="{{ route('tamu.dashboard-spi') }}" class="btn btn-primary icon icon-shape shadow text-center border-radius-md d-flex align-items-center justify-content-center"
              style="height: 50px; width: 50px; border-radius: 8px;">
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          ...
          <div class="col-4 text-end">
            <a href="{{ route('tamu.dashboard-ncr') }}" class="btn btn-primary icon icon-shape shadow text-center border-radius-md d-flex align-items-center justify-content-center"
              style="height: 50px; width: 50px; border-radius: 8px;">
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          ...
          <div class="col-4 text-end">
            <a href="{{ route('tamu.dashboard-budget') }}" class="btn btn-primary icon icon-shape shadow text-center border-radius-md d-flex align-items-center justify-content-center"
              style="height: 50px; width: 50px; border-radius: 8px; ">
...
<div class="row mt-4">
  <div class="row mb-3 align-items-center">
    <div class="col-md-6">
      <form method="GET" action="{{ route('tamu.dashboard') }}">
      ...
      <div class="card z-index-2">
        ...
        <div class="card-body p-3">
          <div class="chart">
            ...
            <form method="POST" action="{{ route('tamu.set-compliance-target') }}" class="mb-3">
              @csrf
