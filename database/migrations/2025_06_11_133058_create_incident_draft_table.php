...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('incident_draft', function (Blueprint $table) {
            ...
            $table->string('deskripsi_tindakan_pencegahan_1', 255)->nullable();
            ...
            $table->string('deskripsi_tindakan_pencegahan_2', 255)->nullable();
            ...
            $table->string('deskripsi_tindakan_pencegahan_3', 255)->nullable();
