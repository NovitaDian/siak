...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('incidents_fix', function (Blueprint $table) {
            ...
            $table->string('deskripsi_tindakan_pencegahan_1')->nullable();
            ...
            $table->string('deskripsi_tindakan_pencegahan_2')->nullable();
            ...
            $table->string('deskripsi_tindakan_pencegahan_3')->nullable();
